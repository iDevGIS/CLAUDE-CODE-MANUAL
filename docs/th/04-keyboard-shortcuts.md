...
- **`keybindingFlavor: "readline"` จับคู่ปุ่มระดับคำให้เหมือน Bash ด้วยแล้ว** — `Alt+F` และ `Ctrl`/`Option+→` หยุดที่ท้ายคำ, `Alt+D` ลบไปจนถึงท้ายคำ (กด `Ctrl+Y` วางกลับได้) และเครื่องหมายวรรคตอนถือเป็นตัวแบ่งคำ ดูที่ [[06-configuration]]
...
- **ปุ่มแก้ไขระดับคำในช่อง prompt เป็นแบบ Bash เสมอแล้ว** — `Ctrl+W` ลบย้อนถึงช่องว่าง, `Alt+F` กับ `Alt+D` หยุดที่ท้ายคำ และเครื่องหมายวรรคตอนถือเป็นตัวแบ่งคำ; setting `keybindingFlavor` ไม่มีผลอีกต่อไป ดู [[06-configuration]]
