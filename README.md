...
## 🆕 มีอะไรใหม่ — sync ตาม Claude Code `v2.1.209`
...
> 📋 ดูครบทุกเวอร์ชันใน [`CHANGELOG.md`](./CHANGELOG.md) — คู่มืออ้างอิง Claude Code `v2.1.209` (manual `v1.18.0`)
...
### 🔄 อัปเดตสด
ตรงกับ Claude Code **v2.1.209** + โมเดล Fable 5 / Sonnet 5
