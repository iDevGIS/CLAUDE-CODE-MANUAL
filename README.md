...
## 🆕 มีอะไรใหม่ — sync ตาม Claude Code `v2.1.218`
...
> 📋 ดูครบทุกเวอร์ชันใน [`CHANGELOG.md`](./CHANGELOG.md) — คู่มืออ้างอิง Claude Code `v2.1.218` (manual `v1.26.0`)
...
### 🔄 อัปเดตสด
ตรงกับ Claude Code **v2.1.218** + โมเดล Fable 5 / Sonnet 5
