...
## 🆕 มีอะไรใหม่ — sync ตาม Claude Code `v2.1.258`
...
> 📋 ดูครบทุกเวอร์ชันใน [`CHANGELOG.md`](./CHANGELOG.md) — คู่มืออ้างอิง Claude Code `v2.1.258` (manual `v1.55.0`)
...
### 🔄 อัปเดตสด
ตรงกับ Claude Code **v2.1.258** + โมเดล Fable 5.1 / Opus 5 / Sonnet 5
