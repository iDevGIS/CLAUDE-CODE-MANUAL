...
| 🧠 **Atomic / Obsidian-friendly** | 38 โน้ตเล็กต่อภาษา + frontmatter + wikilinks | เปิดใน Obsidian ดู Graph View, เลือกอ่านเฉพาะหัวข้อ | [`docs/th/README.md`](./docs/th/README.md) · [`docs/en/README.md`](./docs/en/README.md) |
...
<details>
<summary><b>📖 กดดูสารบัญทั้ง 38 บท</b> — มือใหม่ · พื้นฐาน · ตั้งค่า · ขั้นสูง · ใช้งานจริง · Tutorial · Cookbook</summary>
