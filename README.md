...
## 🆕 มีอะไรใหม่ — sync ตาม Claude Code `v2.1.231`
...
> 📋 ดูครบทุกเวอร์ชันใน [`CHANGELOG.md`](./CHANGELOG.md) — คู่มืออ้างอิง Claude Code `v2.1.231` (manual `v1.37.0`)
...
### 🔄 อัปเดตสด
ตรงกับ Claude Code **v2.1.231** + โมเดล Fable 5 / Opus 5 / Sonnet 5
