...
## 🆕 มีอะไรใหม่ — sync ตาม Claude Code `v2.1.282`
...
> 📋 ดูครบทุกเวอร์ชันใน [`CHANGELOG.md`](./CHANGELOG.md) — คู่มืออ้างอิง Claude Code `v2.1.282` (manual `v1.75.0`)
...
### 🔄 อัปเดตสด
ตรงกับ Claude Code **v2.1.282** + โมเดล Fable 5.1 / Opus 5.5 / Sonnet 5
