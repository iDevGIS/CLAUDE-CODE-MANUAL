...
## 🆕 มีอะไรใหม่ — sync ตาม Claude Code `v2.1.228`
...
> 📋 ดูครบทุกเวอร์ชันใน [`CHANGELOG.md`](./CHANGELOG.md) — คู่มืออ้างอิง Claude Code `v2.1.228` (manual `v1.35.0`)
...
### 🔄 อัปเดตสด
ตรงกับ Claude Code **v2.1.228** + โมเดล Fable 5 / Opus 5 / Sonnet 5
