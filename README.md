...
## 🆕 มีอะไรใหม่ — sync ตาม Claude Code `v2.1.212`
...
> 📋 ดูครบทุกเวอร์ชันใน [`CHANGELOG.md`](./CHANGELOG.md) — คู่มืออ้างอิง Claude Code `v2.1.212` (manual `v1.21.0`)
...
### 🔄 อัปเดตสด
ตรงกับ Claude Code **v2.1.212** + โมเดล Fable 5 / Sonnet 5
