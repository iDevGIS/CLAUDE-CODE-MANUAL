...
## 🆕 What's new — synced to Claude Code `v2.1.283`
...
> 📋 Full per-version history in [`CHANGELOG.md`](./CHANGELOG.md) — manual references Claude Code `v2.1.283` (manual `v1.76.0`)
...
### 🔄 Always current
Tracks Claude Code **v2.1.283** + the Fable 5.1 / Opus 5.5 / Sonnet 5 lineup
