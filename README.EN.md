...
[![Claude Code](https://img.shields.io/badge/Claude_Code-v2.1.238-7B61FF?style=flat-square)](https://docs.claude.com/claude-code)
[![Manual](https://img.shields.io/badge/Manual-v1.44.0-22C55E?style=flat-square)](./CHANGELOG.md)
...
## 🆕 What's new — synced to Claude Code `v2.1.238`
...
> 📋 Full per-version history in [`CHANGELOG.md`](./CHANGELOG.md) — manual references Claude Code `v2.1.238` (manual `v1.44.0`)
...
### 🔄 Always current
Tracks Claude Code **v2.1.238** + the Fable 5 / Opus 5 / Sonnet 5 lineup
