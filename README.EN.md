...
## 🆕 What's new — synced to Claude Code `v2.1.240`
...
> 📋 Full per-version history in [`CHANGELOG.md`](./CHANGELOG.md) — manual references Claude Code `v2.1.240` (manual `v1.46.0`)
...
### 🔄 Always current
Tracks Claude Code **v2.1.240** + the Fable 5 / Opus 5 / Sonnet 5 lineup
